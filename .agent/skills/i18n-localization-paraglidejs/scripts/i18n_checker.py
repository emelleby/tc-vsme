...
Scans for untranslated text in React (Paraglide JS, react-i18next), Vue, and Python files.
Supports: Paraglide JS, react-i18next, next-intl, Vue i18n, Python gettext.
"""
import sys
import re
import json
...
I18N_PATTERNS = [
    r"m\.[a-zA-Z_]",  # m.key() - Paraglide JS
    r'from ["\']@/paraglide/messages["\']',  # Paraglide import
    r"getLocale\(",  # Paraglide runtime
    r"setLocale\(",  # Paraglide runtime
    r"locales",  # Paraglide runtime
